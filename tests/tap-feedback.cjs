...
assert(ui.includes(':is(.asset-card,.quick-asset,.json-reference-row,.library-list-row,.repo-switcher,.group-pill,.library-picker,.library-picker-option):focus-within{outline:2px solid var(--ui-line-focus);outline-offset:2px}'));
