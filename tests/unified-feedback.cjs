...
assert(html.includes('styles.css?v=login-appearance-57'));
assert(html.includes('console.css?v=login-appearance-57'));
assert(html.includes('ui-refresh.css?v=login-appearance-57'));
assert(html.includes('console.js?v=login-appearance-57'));
