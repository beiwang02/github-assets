...
assert(html.includes('styles.css?v=detail-link-align-56'));
assert(html.includes('console.css?v=detail-link-align-56'));
assert(html.includes('ui-refresh.css?v=detail-link-align-56'));
assert(html.includes('console.js?v=detail-link-align-56'));
