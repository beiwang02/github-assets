...
assert(html.includes('styles.css?v=dropzone-quiet-51'));
assert(html.includes('console.css?v=dropzone-quiet-51'));
assert(html.includes('ui-refresh.css?v=dropzone-quiet-51'));
assert(html.includes('console.js?v=dropzone-quiet-51'));
