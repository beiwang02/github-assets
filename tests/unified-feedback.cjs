...
assert(html.includes('styles.css?v=modal-dismiss-busy-55'));
assert(html.includes('console.css?v=modal-dismiss-busy-55'));
assert(html.includes('ui-refresh.css?v=modal-dismiss-busy-55'));
assert(html.includes('console.js?v=modal-dismiss-busy-55'));
