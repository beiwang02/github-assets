...
assert(html.includes('styles.css?v=repo-settings-entry-52'));
assert(html.includes('console.css?v=repo-settings-entry-52'));
assert(html.includes('ui-refresh.css?v=repo-settings-entry-52'));
assert(html.includes('console.js?v=repo-settings-entry-52'));
