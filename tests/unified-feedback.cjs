...
assert(html.includes('styles.css?v=group-menu-48'));
assert(html.includes('console.css?v=group-menu-48'));
assert(html.includes('ui-refresh.css?v=group-menu-48'));
assert(html.includes('console.js?v=group-menu-48'));
