...
assert(css.includes('#uploadForm .modal-inline-create{justify-content:flex-start;align-items:flex-start;text-align:left;padding:0;min-height:40px;border:0;background:transparent;color:var(--primary);text-decoration:none}'));
...
assert(read('index.html').includes('ui-refresh.css?v=focus-activation-37'));
